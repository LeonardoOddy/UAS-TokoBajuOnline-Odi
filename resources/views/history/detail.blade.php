        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses di Check out. Selanjutnya lakukan pembayaran dengan transfer bank
                        <br> di Rekening
                        <strong>Bank BRI Nomor Rekening : 02020-119041-143</strong> dengan nominal : <strong>
                            Rp. {{number_format ($pesanan->kode+$pesanan->jumlah_harga)}}</strong>
                    </h5>
